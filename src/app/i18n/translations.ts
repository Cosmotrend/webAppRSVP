...
export const translations = {
  ...
  rsvp: {
    ...
    perk4: { fr: 'Masterclass quotidiennes à 14h00', ar: 'ماستر كلاس كل نهار على 14.00h' },
  ...
  confirmation: {
    ...
    perk4Desc: { fr: 'Chaque jour à 14h00', ar: 'كل نهار على 14.00h' },
    ...
    masterclassTitle: { fr: 'Masterclass quotidiennes à 14h00', ar: 'ماستر كلاس كل نهار على 14.00h' },
