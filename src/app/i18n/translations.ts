...
export const translations = {
  ...
  rsvp: {
    ...
    perk3: { fr: 'VTC privé offert — transport premium', ar: 'VTC خاص مجاني — نقل بريميوم' },
  ...
  confirmation: {
    ...
    perk3: { fr: 'VTC privé offert', ar: 'VTC خاص مجاني' },
    ...
    downloadSub: { fr: 'Image PNG', ar: 'صورة PNG' },
  ...
  wheelCode: {
    ...
    ticketHint: { fr: 'Format: SD26-001 → SD26-1000', ar: 'SD26-001 → SD26-1000 :الفورما' },
    devisLabel: { fr: 'Numéro de Devis', ar: 'رقم الدوفي' },
    devisHint: { fr: 'Format: S26XXX (6 caractères)', ar: '(6 حروف) S26XXX :الفورما' },
