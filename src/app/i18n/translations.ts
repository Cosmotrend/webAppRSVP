...
export const translations = {
  ...
  rsvp: {
    ...
    perk4: { fr: 'Masterclass quotidiennes à 14h00', ar: 'ماستر كلاس كل نهار على 14:00' },
    ...
    submittingStep1: { fr: 'Vérification de vos informations', ar: 'كنتأكدو من المعلومات ديالك' },
    submittingStep2: { fr: 'Génération de votre billet VIP', ar: 'كنخلقو التيكي VIP ديالك' },
    submittingStep3: { fr: 'Préparation de votre confirmation', ar: 'كنحضرو التأكيد ديالك' },
    submittingHint: { fr: 'Merci de patienter quelques instants', ar: 'تسنى شي ثواني عافاك' },
  ...
  confirmation: {
    ...
    masterclassTitle: { fr: 'Masterclass quotidiennes à 14h00', ar: 'ماستر كلاس كل نهار على 14:00' },
